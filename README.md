...
> Python tool to scrape Indeed job postings with full details

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/scrape-indeed-job-postings?style=flat-square)](https://github.com/data-scrape/scrape-indeed-job-postings)
[![Forks](https://img.shields.io/github/forks/data-scrape/scrape-indeed-job-postings?style=flat-square)](https://github.com/data-scrape/scrape-indeed-job-postings/forks)
...
**Scrape Indeed Job Postings** is a free, open-source Python scraper for **Indeed**. Extract structured data from indeed with full pagination support, proxy rotation, and multiple export formats.

scrape indeed job postings, indeed job postings scraper, indeed posting scraper

## ✨ Features

- ✅ Full job posting details extraction
...
```bash
git clone https://github.com/data-scrape/scrape-indeed-job-postings.git
cd scrape-indeed-job-postings
...
```bash
python scraper.py "Data Scientist remote jobs"
```
...
`job_id` | `title` | `company` | `location` | `remote_type` | `salary_min` | `salary_max` | `experience_level` | `education` | `benefits` | `requirements` | `description` | `url`
